...
Singleton {
    ...
    property real configuredBackgroundTransparency: Config?.options.appearance.transparency.enable ? Config?.options.appearance.transparency.automatic ? autoBackgroundTransparency : Config?.options.appearance.transparency.backgroundTransparency : 0
    ...
    animationCurves: QtObject {
        // Smooth mode avoids control-point overshoot; expressive preserves the
        // previous springier material motion as an opt-in style.
        readonly property list<real> expressiveFastSpatial: root.motionStyle === "smooth" ? [0.16, 1, 0.3, 1, 1, 1] : [0.42, 1.67, 0.21, 0.90, 1, 1]
        readonly property list<real> expressiveDefaultSpatial: root.motionStyle === "smooth" ? [0.2, 0, 0, 1, 1, 1] : [0.38, 1.21, 0.22, 1.00, 1, 1]
        readonly property list<real> expressiveSlowSpatial: root.motionStyle === "smooth" ? [0.16, 1, 0.3, 1, 1, 1] : [0.39, 1.29, 0.35, 0.98, 1, 1]
        ...
        readonly property real expressiveFastSpatialDuration: root.motionDuration(350)
        readonly property real expressiveDefaultSpatialDuration: root.motionDuration(500)
        readonly property real expressiveSlowSpatialDuration: root.motionDuration(650)
        readonly property real expressiveEffectsDuration: root.motionDuration(200)
    }
    ...
    animation: QtObject {
        ...
        property QtObject elementMoveEnter: QtObject {
            property int duration: root.motionDuration(400)
            property int type: Easing.BezierSpline
        ...
        property QtObject elementMoveExit: QtObject {
            property int duration: root.motionDuration(200)
            property int type: Easing.BezierSpline
        ...
        property QtObject elementResize: QtObject {
            ...
            property int type: Easing.BezierSpline
            property list<real> bezierCurve: root.motionStyle === "smooth" ? animationCurves.standardDecel : animationCurves.emphasized
            property int velocity: 650
            property Component numberAnimation: Component {
                NumberAnimation {
                    alwaysRunToEnd: true
        ...
        property QtObject clickBounce: QtObject {
            property int duration: root.motionDuration(root.motionStyle === "smooth" ? 180 : 400)
            property int type: Easing.BezierSpline
            property list<real> bezierCurve: root.motionStyle === "smooth" ? animationCurves.standardDecel : animationCurves.expressiveDefaultSpatial
            property int velocity: 850
            property Component numberAnimation: Component { NumberAnimation {
                alwaysRunToEnd: true
