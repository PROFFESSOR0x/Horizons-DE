    ...
    PanelWindow {
        ...
        Loader {
            ...
            sourceComponent: Item {
                Binding { target: panelWindow.WlrLayershell; property: "namespace"; value: "quickshell:keybindsOverlay" }
                Binding { target: panelWindow.WlrLayershell; property: "layer"; value: WlrLayer.Overlay }
                Binding { target: panelWindow.WlrLayershell; property: "keyboardFocus"; value: GlobalStates.keybindsOverlayOpen ? WlrKeyboardFocus.OnDemand : WlrKeyboardFocus.None }
            }
        }
        color: "transparent"
