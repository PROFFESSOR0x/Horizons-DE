...
Item {
    ...
    readonly property var mediaOptions: useM3IslandConfig
        ? Config.options.m3Island.media : Config.options.bar.media
    
    property bool vertical: false
    property bool borderless: Config.options.bar.borderless
    property bool isMaterial: useM3IslandConfig || Config.options.bar.cornerStyle === 3
    readonly property MprisPlayer activePlayer: {
        const preferred = root.mediaOptions.preferredPlayer.trim().toLowerCase()
    ...
    implicitWidth: vertical 
        ...
        : (isMaterial 
            ...
            : Math.max(
                root.mediaOptions.minWidth,
                Math.min(rowLayout.implicitWidth + 8, root.mediaOptions.maxWidth)
            ))
    ...
    Loader {
        ...
        sourceComponent: RowLayout {
            ...
            StyledText {
                visible: root.useM3IslandConfig ? Config.options.m3Island.verbose : Config.options.bar.verbose
                Layout.alignment: Qt.AlignVCenter
                ...
                text: root.mediaOptions.onlyTitle ? root.cleanedTitle : `${root.cleanedTitle}${root.activePlayer?.trackArtist ? ' • ' + root.activePlayer.trackArtist : ''}`
            }
        }
    }
