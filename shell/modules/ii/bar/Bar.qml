...
Scope {
    ...
    Variants {
        ...
        LazyLoader {
            id: barLoader
            active: GlobalStates.barOpen && !GlobalStates.screenLocked && !GlobalStates.lockPreviewOpen
            ...
            component: PanelWindow { // Bar window
                ...
                MouseArea  {
                    ...
                    BarContent {
                        ...
                        // keep opacity fade only — scale removed per user request
                        opacity: (Config?.options.bar.autoHide.enable && !mustShow) ? 0.85 : 1
                        ...
                        Behavior on anchors.topMargin {
                            NumberAnimation {
                                duration: mustShow ? Appearance.animation.elementMoveEnter.duration : Appearance.animation.elementMoveExit.duration
                                easing.type: mustShow ? Appearance.animation.elementMoveEnter.type : Appearance.animation.elementMoveExit.type
                                easing.bezierCurve: mustShow ? Appearance.animation.elementMoveEnter.bezierCurve : Appearance.animation.elementMoveExit.bezierCurve
                                alwaysRunToEnd: true
                            }
                        }
                        ...
                        Behavior on opacity {
                            NumberAnimation {
                                duration: mustShow ? Appearance.animation.elementMoveEnter.duration : 200
                                easing.type: mustShow ? Appearance.animation.elementMoveEnter.type : Easing.OutCubic
                                easing.bezierCurve: mustShow ? Appearance.animation.elementMoveEnter.bezierCurve : Appearance.animationCurves.standardDecel
                            }
                        }
