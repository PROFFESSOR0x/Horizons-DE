...
Item {
    id: root
    // M3 Island reuses this component but owns a separate preference group.
    property bool useM3IslandConfig: false
    readonly property var buttonOptions: useM3IslandConfig
        ? Config.options.m3Island.utilButtons : Config.options.bar.utilButtons
    property bool borderless: Config.options.bar.borderless
    property bool vertical: useM3IslandConfig ? false : Config.options.bar.vertical
    property bool isMaterial: useM3IslandConfig || Config.options.bar.cornerStyle === 3
    ...
    Flow {
        ...
        Loader {
            active: root.buttonOptions.showScreenSnip
            visible: active
        ...
        Loader {
            active: root.buttonOptions.showColorPicker
            visible: active
        ...
        Loader {
            active: root.buttonOptions.showScreenRecord
            visible: active
        ...
        Loader {
            active: root.buttonOptions.showKeyboardToggle
            visible: active
        ...
        Loader {
            active: root.buttonOptions.showWallpaperToggle
            visible: active
        ...
        Loader {
            active: root.buttonOptions.showMicToggle
            visible: active
        ...
        Loader {
            active: root.buttonOptions.showDarkModeToggle
            visible: active
        ...
        Loader {
            active: root.buttonOptions.showPerformanceProfileToggle
            visible: active
