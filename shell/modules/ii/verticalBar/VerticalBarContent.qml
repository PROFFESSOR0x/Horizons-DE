                        ...
                        Bar.BarGroup {
                            ...
                            Loader {
                                ...
                                onLoaded: {
                                    ...
                                    root.configureVisualizer(item, modelData, root.effectiveLeftLayout, index)
                                }
                            }
                        }
                    }
                    ...
                    Component {
                        ...
                        Bar.BarGroup {
                            ...
                            Loader {
                                ...
                                onLoaded: {
                                    if (item && "vertical" in item) item.vertical = true
                                    root.configureVisualizer(item, modelData, root.effectiveMiddleLayout, index)
                                }
                            }
                        }
                    }
                    ...
                    Component {
                        ...
                        Bar.BarGroup {
                            ...
                            Loader {
                                ...
                                onLoaded: {
                                    if (item && "vertical" in item) item.vertical = true
                                    root.configureVisualizer(item, modelData, root.effectiveRightLayout, index)
                                }
                            }
                        }
                    }
