...
Scope {
    ...
    PanelWindow {
        id: root
        readonly property string displayMode: Config.options.notifications.displayMode ?? "toast"
        // History-only deliberately keeps notifications out of the screen edge.
        // Island is a dedicated M3 experience, with a safe toast fallback for
