...
Scope {
    ...
    Loader {
        ...
        sourceComponent: PanelWindow { // Session menu
            ...
            Timer {
                id: destructiveConfirmTimer
                interval: 3500
                onTriggered: {
                    sessionRoot.pendingDestructiveAction = ""
                    sessionRoot.pendingDestructiveCallback = null
            ...
            anchors {
                top: true
                bottom: edgeMode
                left: !edgeMode || edgeOnLeft
                right: !edgeMode || !edgeOnLeft
            }

            implicitWidth: edgeMode ? Config.options.sessionScreen.edgeWidth : (root.focusedScreen?.width ?? 0)
            implicitHeight: root.focusedScreen?.height ?? 0

            Component.onCompleted: Qt.callLater(() => sessionRoot.edgeSlideOffset = 0)

            Rectangle {
                anchors.fill: parent
                visible: sessionRoot.edgeMode
                color: Appearance.colors.colLayer0
                border.width: 1
                border.color: Appearance.colors.colLayer0Border
                topLeftRadius: sessionRoot.edgeOnLeft ? 0 : Appearance.rounding.verylarge
                bottomLeftRadius: sessionRoot.edgeOnLeft ? 0 : Appearance.rounding.verylarge
                topRightRadius: sessionRoot.edgeOnLeft ? Appearance.rounding.verylarge : 0
                bottomRightRadius: sessionRoot.edgeOnLeft ? Appearance.rounding.verylarge : 0
            }
            ...
            ColumnLayout { // Content column
                ...
                spacing: 15
                transform: Translate { x: sessionRoot.edgeSlideOffset }
                ...
                GridLayout {
                    ...
                    SessionActionButton {
                        ...
                        visible: Config.options.sessionScreen.showTaskManager
                    ...
                    SessionActionButton {
                        id: sessionHibernate
                        visible: Config.options.sessionScreen.showHibernate
                    ...
                    SessionActionButton {
                        ...
                        onClicked: {
                            sessionRoot.runDestructiveAction(buttonText, () => Session.poweroff());
                        }
                        onFocusChanged: {
                            if (focus)
                                sessionRoot.subtitle = buttonText;
                    ...
                    SessionActionButton {
                        ...
                        onClicked: {
                            sessionRoot.runDestructiveAction(buttonText, () => Session.reboot());
                        }
                        onFocusChanged: {
                            if (focus)
                                sessionRoot.subtitle = buttonText;
                    ...
                    SessionActionButton {
                        ...
                        visible: Config.options.sessionScreen.showFirmware
                        buttonIcon: "settings_applications"
                        buttonText: Translation.tr("Reboot to firmware settings")
                        onClicked: {
                            sessionRoot.runDestructiveAction(buttonText, () => Session.rebootToFirmware());
                        }
                        onFocusChanged: {
                            if (focus)
                                sessionRoot.subtitle = buttonText;
            ...
            ColumnLayout {
                visible: Config.options.sessionScreen.showWarnings
                anchors {
