...
-- Animations (auto-generated by the shell's animation editor, optional).
-- Loaded after hyprland.general so its preset/custom leaves win over the
-- baked-in defaults there.
