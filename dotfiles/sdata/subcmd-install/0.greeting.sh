...
printf "\n"
printf "${STY_PURPLE}${STY_BOLD}[NEW] آفاق | Horizons (based on illogical-impulse) is now powered by Quickshell.${STY_RST}\n"
printf "${STY_PURPLE}"
printf '# NOTE: the AGS version of illogical-impulse is no longer supported.\n'
